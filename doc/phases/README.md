...
| B2 | Capture image | D4 | `Capture Image - Refined Palette & Layout` `screens/27fc5a5d81874c31be0de3e4e82acb50` / `Capture Image - Mobile View` `screens/5e8e11790668474b948578dcbe08ba3c` — UX refresh (#162): always-visible tap-to-capture tile, auto-recognise, renamed **Items** panel with tappable recognised-item rows. Supersedes `99b7a1dce…` / `5aa6c04e…`. |
...
| C1′ | Move-wide review queue (#654) | — | No Stitch screen — composed from existing patterns (Gallery grid tile + ViewToggle + the C2 screen in queue mode). See `DESIGN-DISCREPANCIES.md` §C1-MOVE-QUEUE. |
| C2 | Review by photo | D6 (#143) | `Review Item-by-Item (Dark) - Responsive` `screens/c2c865975366419998a26905710a85f3` / `Review Item-by-Item (Light) - Mobile View` `screens/c5718290b1404577ad4946933875ffd6` — *edit / remove / mark-or-ignore* model (#660 made reviewing explicit — Mark as Reviewed / Ignore at header+footer replace the single Next Photo and the reviewed-when-shown open; supersedes `ad0e4e2b…` / `aa4b6520…`). |
| C3 | Item detail / edit | D5 | `Item Detail / Edit (Dark) - Responsive Desktop` `screens/ecaa6194de654949bca03cad9566a83c` / `Item Detail / Edit - Mobile View` `screens/eb456e9d845540b180f1a5884f844b7e` — UX refresh (#162): auto-save with inline **Saved ✓** badge (no Save button), danger (red) **Remove**. Supersedes `7a371b5d…` / `9fc6d2e9…`. |
