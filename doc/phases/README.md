...
| C1 | Review queue | D6 | `Review Queue (Dark) - Responsive` `screens/688eefb9976143f7b5bc4b0ab930a75f` / `Review Queue (Light) - Mobile` `screens/ee18e1c1003a475b98f1dbaf680539af` |
| C2 | Review item-by-item | D6 | `Review Item-by-Item (Dark) - Responsive` `screens/ad0e4e2b88d9465d80f788e1310f8ff6` / `Review Item-by-Item (Light) - Mobile` `screens/aa4b6520bd734b80b5c5c288125b68d4` |
