...
module RecognitionProviders
  ...
  # thing the item is (#626). The family is near-invisible metadata: folded into
  # the search projection text (and the cluster engine, #625), rendered in one
  # place only — the insurance declaration's theme grouping (#702); nil when the
  # model was unsure. The visible item itself stays just a name —
