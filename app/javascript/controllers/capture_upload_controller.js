...
export default class extends Controller {
  ...
  tagOrientation(bytes, orientation) {
    const app1 = [
      // APP1, length (0x1e = 30: counted from the length field to the segment
      // end — the 2 length bytes + "Exif\0\0"(6) + TIFF(8) + IFD count(2) +
      // one 12-byte entry), then "Exif\0\0".
      0xff, 0xe1, 0x00, 0x1e, 0x45, 0x78, 0x69, 0x66, 0x00, 0x00,
      0x4d, 0x4d, 0x00, 0x2a, 0x00, 0x00, 0x00, 0x08, // "MM", magic, IFD offset 8
      0x00, 0x01, // 1 entry
